...
class WeaponProfileForm(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            "strength_dice_expr": "Strength dice",
            "strength_user_bonus": "User bonus",
            "damage_type": "Damage type",
            "damage_value": "Damage value",
            "damage_dice_expr": "Damage dice",
            "save_modifier": "Save modifier",
            "ammo_type": "Ammo roll type",
            "ammo_target": "Ammo target number",
            "description": "Description",
            "cost": "Cost (credits)",
            "per_shot": "Cost is per shot",
        }
        widgets = {
            "strength_dice_expr": forms.TextInput(attrs={"placeholder": "e.g., D6, 2D6, D6+2"}),
            "damage_dice_expr": forms.TextInput(attrs={"placeholder": "e.g., D, D3-D10, 2D6"}),
        }
